  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="rounded-[28px] border border-line bg-white p-5">
            ...
            <div className="mt-4 space-y-3">
              {approved.length === 0 ? (
                <p className="text-sm text-mute">No approved drafts are waiting for a date.</p>
              ) : (
                approved.map((draft) => (
      ...
      <SectionFrame
        ...
        description="Marking an item sent uses the email adapter. In mock mode it records the event without live delivery."
      >
